import 'dart:async';
import 'dart:convert';
import 'package:covid19/models/KecamatanM.dart';
import 'package:covid19/models/KelurahanM.dart';
import 'package:covid19/models/KotaM.dart';
import 'package:covid19/provider/Kecamatan.dart';
import 'package:covid19/provider/Kelurahan.dart';
import 'package:covid19/provider/Kota.dart';
import 'package:flushbar/flushbar.dart';
import 'package:pk_skeleton/pk_skeleton.dart';
import 'package:loading_animations/loading_animations.dart';
import 'package:covid19/Utils/BottomAnimation.dart';
import 'package:intl/intl.dart';
import 'package:covid19/provider/Akun.dart';
import 'package:covid19/provider/Auth.dart';
import 'package:covid19/screen/LoginScreen3.dart';
...
class DataDiri extends StatefulWidget {
  ...
  @override
  _DataDiriState createState() {
    return _DataDiriState();
  }
}

class _DataDiriState extends State<DataDiri> {
  GoogleSignIn _googleSignIn = GoogleSignIn();
  List<dynamic> dataDiri = [];
